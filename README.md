...
- [전체 모델 (현재 정확도 = 0.71)](https://colab.research.google.com/drive/1auAwJSL9I0QecoeIsAGDE6TFOCDdksyc#scrollTo=OxogKchJZDZM) [참고](https://github.com/lyakaap/NetVLAD-pytorch)
